...
class PathfinderTest:
  ...
  @Test def testFindNextStepWithObstacleInDirectPath(): Unit =
    ...
    val targetPos = (4, 2)
    grid.setCell(soldier, startPos)
    grid.setCell(obstacle, blockingPos)
  ...
  @Test def testFindNextStepWithAllSidesSurroundedByObstacles(): Unit =
    ...
    grid.setCell(wall(id = "w1"), (3, 3))
    grid.setCell(wall(id = "w2"), (3, 4))
    grid.setCell(wall(id = "w3"), (4, 3))
    grid.setCell(wall(id = "w4"), (4, 5))
    grid.setCell(wall(id = "w5"), (5, 3))
    grid.setCell(wall(id = "w6"), (5, 4))
